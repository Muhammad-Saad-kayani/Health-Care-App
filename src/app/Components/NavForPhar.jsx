    ...
    <nav className="w-full bg-white py-5 px-10 flex flex-wrap gap-2 shadow-custom-light fixed top-0 z-50">
        ...
        <div className="searchsec w-600 flex items-center">
          <div className="search h-12 flex items-center border-2 border-blue-300 rounded-lg overflow-hidden">
            ...
            <div className="flex items-center justify-center text-center">
              <button className="searchbtn w-16 h-12 flex items-center text-center justify-center bg-blue-500 text-white border-none">
      ...
      <section className="navsec nav-links w-full py-2 flex justify-between gap-8">
        <div className="flex justify-center gap-8">
          ...
          >
            <a className="text-blue-900 hover:underline cursor-pointer">Medications</a>
          ...
          <div
            ...
            onMouseLeave={handleDropdownClose}
          >
            <a className="text-blue-900 hover:underline cursor-pointer">Wellness And Beauty</a>
            {dropdown === 'wellness' && (
              <div
                className="absolute bg-white shadow-md border border-gray-300 rounded-md mt-2 z-10"
                onMouseEnter={handleDropdownContentMouseEnter}
                onMouseLeave={handleDropdownContentMouseLeave}
              >
                <Link href="/Hair-&-Nails" className="block px-4 py-2 hover:bg-gray-100">Hair And Nails Care</Link>
                <Link href="/Oral-Hygiene" className="block px-4 py-2 hover:bg-gray-100">Oral Hygiene</Link>
              </div>
            )}
          </div>
          <div
            ...
            onMouseLeave={handleDropdownClose}
          >
            <a className="text-blue-900 hover:underline cursor-pointer">Devices And Injectables</a>
            {dropdown === 'devices' && (
              <div
                className="absolute bg-white shadow-md border border-gray-300 rounded-md mt-2 z-10"
                onMouseEnter={handleDropdownContentMouseEnter}
                onMouseLeave={handleDropdownContentMouseLeave}
              >
                <Link href="/Devices" className="block px-4 py-2 hover:bg-gray-100">Devices</Link>
                <Link href="/Drips" className="block px-4 py-2 hover:bg-gray-100">Drips</Link>
              </div>
            )}
          </div>
          <a
