      ...
      <section className="containers bg-white py-0">
        <div className="navsec w-full flex items-center justify-center flex-wrap gap-4">
          ...
          <div className="w-full flex justify-between mt-5 gap-5">
            <div className="w-[49%]  bg-[#edf3fc] hover:bg-blehover cursor-pointer flex items-center justify-center flex-wrap p-5">
            ...
            <div className="w-[49%] cursor-pointer flex items-center justify-between flex-wrap gap-4 ">
              ...
              <div className="w-[48%] h-72 rounded-xl bg-[#edf3fc] hover:bg-blehover p-5 flex items-center  flex-wrap justify-center gap-1">
                ...
                <div className="w-full flex flex-wrap gap-2">
                  <div className="w-full text-lg">GAVISCON LIQUID 120ML</div>
                  <div className="w-full text-sm text-gray-500">
          ...
          <a
            href="/"
            className="w-full text-right text-[#3d6093] flex gap-2 justify-end  text-sm font-sans font-bold"
          >
            <div className="">
